        ...
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="{{ route('bookings.store', [$movie, $date, $showtime]) }}" method="POST">
                ...
                <form action="{{ route('payment.create') }}" method="post">
                    ...
                    <!-- Optionally, you can include seat information if needed -->
                    <button class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-primary-500 rounded-lg focus:ring-4 focus:ring-primary-200 hover:bg-primary-600" type="submit">Proceed to Payment</button>
                </form>
