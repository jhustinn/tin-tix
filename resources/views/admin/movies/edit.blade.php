...
<div class="space-y-6">
    ...
    <div class="mt-6 p-4 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div class="overflow-x-auto">
            <form action="{{ route('admin.movies.update') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="w-full">
                        ...
                        <input value="{{ $movie->title }}" type="text" name="title" id="title" aria-label="title"
                ...
                @enderror
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ $movie->date }}" type="date" name="release_date" id="release_date" aria-label="release_date"
                            class="text-gray-900 text-sm rounded-lg block w-full p-2.5">
                            @error('realese_date')
                    <x-error-message :message="$message" />
                @enderror
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ $movie->poster_url }}" type="text" name="poster_url" id="poster_url" aria-label="poster_url"
                            class="text-gray-900 text-sm rounded-lg block w-full p-2.5">
                            @error('poster_url')
                    <x-error-message :message="$message" />
                @enderror
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ $movie->age_rating }}" type="text" name="age_rating" id="age_rating" aria-label="age_rating"
                            class="text-gray-900 text-sm rounded-lg block w-full p-2.5">
                            @error('age_rating')
                    <x-error-message :message="$message" />
                @enderror
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input value="{{ $movie->ticket_price }}" type="number" name="ticket_price" id="ticket_price" aria-label="ticket_price"
                ...
                @enderror
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea value="{{ $movie->description }}" type="text" name="description" id="description" aria-label="description"
